...
public class EncryptionRequest {
	...
	public EncryptionRequest(String receiverPublicKey, String receiverNonce, String senderPrivateKey,
			String senderPublicKey, String senderNonce, String plainTextData) {
