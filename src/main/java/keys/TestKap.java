...
public class TestKap {
	...
	public static void main(String[] args) throws Exception {
		...
		//kapil
		String receiverPublicKey ="BEgbv5cZPa56gk4SoKYsvgNY7544SkoLMhLxcn0GiKYfadrS+3IU4JhjnpZ/YeFa329q1+p9d4yFCkuAUHAfaDw=";
		...
		//kapil
		String randomReceiver = "OqefkfyaXqYpiNikQ0+PgBZ7kbxLSVlEqZNo82Sjgoo=";
